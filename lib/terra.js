...
export async function resolveNft(contentId) {
...
export async function mintNft(connectedWallet, metaId, contentId, dataId, instanceId, tophash, name, description, image, licenseUrl, price ) {
  if (!connectedWallet) {
    return;
  }
